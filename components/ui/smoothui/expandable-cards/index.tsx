        ...
        {cards.map((card) => (
          ...
          >
            <div
              ...
              style={{
                width: "clamp(16.5rem, calc((100vw - 7.5rem) / 4), 17.625rem)",
              }}
            >
              <Image
                alt={card.title}
            ...
            <AnimatePresence mode="popLayout">
              {selectedCard === card.id && (
                <motion.div
                  animate={
                    shouldReduceMotion
                      ? { width: "calc(100% - clamp(16.5rem, calc((100vw - 7.5rem) / 4), 17.625rem))", opacity: 1 }
                      : {
                          width:
                  ...
                  >
                    ...
                    {card.author && (
                      <div className="mt-4 flex items-center gap-3">
                        <div className="relative h-12 w-12 overflow-hidden rounded-full border bg-primary">
                          <Image
