  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1180px] flex-col">
        ...
        >
          Equipment, training, and support designed to help localized cryotherapy become a service you can offer professionally.
        </motion.p>
          ...
          {[
            {
              ...
              description: "A portable localized cryotherapy system designed for professional service environments without a full-room buildout.",
              link: "#equipment",
            },
            {
              eyebrow: "Training",
              title: "Confidence from day one",
              description: "Operator training covers setup, handling, use-case framing, and responsible service delivery before your system moves forward.",
              link: "#training",
            },
            {
              eyebrow: "Support",
              title: "Support that stays with you",
              description: "From first conversation to launch, Atmos helps you answer the practical questions that come up before and after purchase.",
              link: "#support",
            },
          ].map((card, i) => (
            <BentoCard
...
export function BentoCard({
  ...
  return (
    <motion.div
      initial={shouldReduceMotion ? false : { opacity: 0, transform: "translateY(24px) scale(0.97)" }}
