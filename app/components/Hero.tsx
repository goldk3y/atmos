...
import { VideoPlayerModal } from "./video-thumbnail-player";

const WALKTHROUGH_VIDEO_URL = "https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1";
  ...
  return (
    <div className="p-2">
      <motion.section
        ...
        style={{ backgroundImage: 'url("/ecmadao-T8gG3G-fWE0-unsplash.jpg")' }}
      ...
      >
          ...
          <div className="grid w-full grid-cols-[minmax(0,1fr)_minmax(8.75rem,10rem)] gap-4 max-[480px]:grid-cols-1 sm:grid-cols-2 sm:gap-8">
            ...
            <div className="flex flex-col items-end gap-2 self-start pt-8 max-[480px]:pt-0 sm:col-start-1 sm:row-start-2 sm:flex-row sm:items-center sm:gap-4 sm:pt-0">
              <motion.a
                ...
                transition={{ duration: 0.45, delay: 0.75, ease: [0.23, 1, 0.32, 1] }}
              ...
              <motion.button
                ...
                initial={{ opacity: 0, transform: "scale(0.96)" }}
                animate={{ opacity: 1, transform: "scale(1)" }}
                transition={{ duration: 0.45, delay: 0.9, ease: [0.23, 1, 0.32, 1] }}
                whileTap={{ transform: "scale(0.97)" }}
              >
        ...
        <motion.img
          src="/cloud 1.png"
          alt="Cloud 1"
          className="pointer-events-none absolute left-0 top-1/4 z-20 h-[800px] w-[800px] object-contain opacity-40"
          initial={{ transform: "translateX(-15px)", opacity: 0 }}
          animate={{ transform: "translateX(0px)", opacity: 0.4 }}
          transition={{
            transform: { duration: 4, ease: "linear", delay: 1.0 },
            opacity: { duration: 3.5, ease: "linear", delay: 1.0 }
          }}
        />
        <motion.img
          src="/cloud 2.png"
          alt="Cloud 2"
          className="pointer-events-none absolute right-0 top-1/3 z-20 h-[800px] w-[800px] object-contain opacity-40"
          initial={{ transform: "translateX(15px)", opacity: 0 }}
          animate={{ transform: "translateX(0px)", opacity: 0.4 }}
          transition={{
            transform: { duration: 4, ease: "linear", delay: 1.6 },
            opacity: { duration: 3.5, ease: "linear", delay: 1.6 }
          }}
        />
        ...
        <motion.button
          ...
          transition={{ duration: 0.45, delay: 1.05, ease: [0.23, 1, 0.32, 1] }}
