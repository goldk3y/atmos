    ...
    >
      ...
      <div className="mx-auto max-w-[1180px]">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            Swipe through focused examples of where localized cryotherapy fits into professional service environments.
          </motion.p>
        </div>

        <motion.div
          className="relative mx-auto mt-14 max-w-6xl px-0 sm:px-10"
          initial={shouldReduceMotion ? false : { opacity: 0, transform: "translateY(28px) scale(0.98)" }}
              ...
              <SwiperSlide key={video.title}>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 p-6 sm:p-8">
                    <h3 className="text-2xl font-medium text-white">{video.title}</h3>
                    <p className="mt-1 text-sm text-white/80">{video.description}</p>
                  </div>
                </button>
              </SwiperSlide>
            ))}
